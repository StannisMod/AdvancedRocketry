...
public class ShipTransformationManager {
    ...
    private static Vector3dc[] createCollisionNormals(ShipTransform transform) {
        ...
        for (int i = 0; i < newNormals.length; i++) {
            if (newNormals[i].lengthSquared() < 0.01) {
    ...
    public void updateAllTransforms(ShipTransform newTransform, boolean updatePhysicsTransform, boolean updateParentAABB) {
        ...
        if (updatePhysicsTransform) {
            ...
            parent.getPhysicsCalculations().generatePhysicsTransform();
    ...
    public void setCurrentTickTransform(final ShipTransform currentTickTransform) {
        this.currentTickTransform = currentTickTransform;
    }

    @java.lang.SuppressWarnings("all")
    public void setPrevTickTransform(final ShipTransform prevTickTransform) {
        this.prevTickTransform = prevTickTransform;
    }

    @java.lang.SuppressWarnings("all")
    public void setCurrentPhysicsTransform(final ShipTransform currentPhysicsTransform) {
        this.currentPhysicsTransform = currentPhysicsTransform;
    }

    @java.lang.SuppressWarnings("all")
    public void setPrevPhysicsTransform(final ShipTransform prevPhysicsTransform) {
