...
public class EntityCollisionInjector {
        ...
        if (entity instanceof EntityLivingBase) {
            ...
            for (final Triple<PhysicsObject, BlockPos, IBlockState> ladderCollision : ladderCollisions) {
                ...
                if (ladderFacing != null) {
                    ...
                    final AxisAlignedBB ladderBB = ladderCollision.getRight().getBoundingBox(world, ladderCollision.getMiddle()).offset(ladderCollision.getMiddle()).grow(0.4);
                    ...
                    final boolean isLadderFacingDown = ladderNormal.y > 0.8;
                    if (isLadderFacingDown) {
                        continue;
                    }
                    // If the ladder is facing up, then let the player use them like monkey bars
                    final boolean isLadderFacingUp = ladderNormal.y < -0.8;
                    ...
                    if (!isLadderFacingUp) {
                        ...
                        final boolean isPlayerGoingTowardsLadder = originalVelocityDirection.dot(ladderNormal) < -0.1;
                ...
                try {
                    ...
                    if (!fast.arePolygonsSeparated()) {
                        ...
                        if (isStep) {
                            ...
                            if (Math.abs(living.moveForward) > 0.01 || Math.abs(living.moveStrafing) > 0.01) {
                                for (int i = 3; i < 6; i++) {
                                    ...
                                    if (tempResponse.y > 0 && VSMath.canStandOnNormal(fast.getCollisions()[i].getCollisionNormal()) && tempResponse.lengthSquared() < stepSquared) {
                                        if (tempResponse.lengthSquared() < 0.1) {
                                            ...
                                            {
                                                final AxisAlignedBB newEntityBBShrunk = axisalignedbb.shrink(0.15);
    ...
    public static void alterEntityMovementPost(Entity entity, IntermediateMovementVariableStorage storage) {
        ...
        entity.collided = entity.collidedHorizontally || entity.collidedVertically;
        Vector3d entityPosInShip = new Vector3d(entity.posX, entity.posY - 0.20000000298023224, entity.posZ);
        ...
        if (entity instanceof EntityLivingBase) {
            if (!entity.world.isRemote && entity.fallDistance > 3.0F && entity.onGround) {
                ...
                if (!iblockstate.getBlock().isAir(iblockstate, entity.world, blockpos)) {
                    double d0 = Math.min(0.2F + f / 15.0F, 2.5);
                    int i = (int) (150.0 * d0);
                    if (!iblockstate.getBlock().addLandingEffects(iblockstate, (WorldServer) entity.world, blockpos, iblockstate, (EntityLivingBase) entity, i)) {
                        ((WorldServer) entity.world).spawnParticle(EnumParticleTypes.BLOCK_DUST, entity.posX, entity.posY, entity.posZ, i, 0.0, 0.0, 0.0, 0.15000000596046448, Block.getStateId(iblockstate));
                    }
                }
            }
        }
    ...
    public static ArrayList<Polygon> getCollidingPolygonsAndDoBlockCols(Entity entity, Vec3d velocity) {
        ...
        for (PhysicsObject wrapper : ships) {
            ...
            if (wrapper.getChunkClaim().containsChunk(entityChunkX, entityChunkZ)) {
                ...
                int chunkYIndex = MathHelper.floor(entity.posY / 16.0);
                if (chunkYIndex < 0) {
                    chunkYIndex = 0;
                }
    ...
    public static final class IntermediateMovementVariableStorage {
        ...
        public IntermediateMovementVariableStorage(@Nonnull final Vector3dc dxyz, @Nonnull final Vector3dc origDxyz, @Nonnull final Vector3dc origPosXyz, final boolean alreadyOnGround, final double motionYBefore, final float oldFallDistance, @Nonnull final ShipData shipTouched) {
            if (dxyz == null) {
                throw new java.lang.NullPointerException("dxyz is marked non-null but is null");
            }
            if (origDxyz == null) {
                throw new java.lang.NullPointerException("origDxyz is marked non-null but is null");
            }
            if (origPosXyz == null) {
                throw new java.lang.NullPointerException("origPosXyz is marked non-null but is null");
            }
            if (shipTouched == null) {
                throw new java.lang.NullPointerException("shipTouched is marked non-null but is null");
            }
            this.dxyz = dxyz;
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof EntityCollisionInjector.IntermediateMovementVariableStorage)) return false;
            final EntityCollisionInjector.IntermediateMovementVariableStorage other = (EntityCollisionInjector.IntermediateMovementVariableStorage) o;
            final java.lang.Object this$dxyz = this.getDxyz();
            final java.lang.Object other$dxyz = other.getDxyz();
            if (this$dxyz == null ? other$dxyz != null : !this$dxyz.equals(other$dxyz)) return false;
            final java.lang.Object this$origDxyz = this.getOrigDxyz();
            final java.lang.Object other$origDxyz = other.getOrigDxyz();
            if (this$origDxyz == null ? other$origDxyz != null : !this$origDxyz.equals(other$origDxyz)) return false;
            final java.lang.Object this$origPosXyz = this.getOrigPosXyz();
            final java.lang.Object other$origPosXyz = other.getOrigPosXyz();
            if (this$origPosXyz == null ? other$origPosXyz != null : !this$origPosXyz.equals(other$origPosXyz)) return false;
            if (this.isAlreadyOnGround() != other.isAlreadyOnGround()) return false;
            if (java.lang.Double.compare(this.getMotionYBefore(), other.getMotionYBefore()) != 0) return false;
            if (java.lang.Float.compare(this.getOldFallDistance(), other.getOldFallDistance()) != 0) return false;
            final java.lang.Object this$shipTouched = this.getShipTouched();
            final java.lang.Object other$shipTouched = other.getShipTouched();
            if (this$shipTouched == null ? other$shipTouched != null : !this$shipTouched.equals(other$shipTouched)) return false;
            return true;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            final java.lang.Object $dxyz = this.getDxyz();
            result = result * PRIME + ($dxyz == null ? 43 : $dxyz.hashCode());
            final java.lang.Object $origDxyz = this.getOrigDxyz();
            result = result * PRIME + ($origDxyz == null ? 43 : $origDxyz.hashCode());
            final java.lang.Object $origPosXyz = this.getOrigPosXyz();
            result = result * PRIME + ($origPosXyz == null ? 43 : $origPosXyz.hashCode());
            result = result * PRIME + (this.isAlreadyOnGround() ? 79 : 97);
            final long $motionYBefore = java.lang.Double.doubleToLongBits(this.getMotionYBefore());
            result = result * PRIME + (int) ($motionYBefore >>> 32 ^ $motionYBefore);
            result = result * PRIME + java.lang.Float.floatToIntBits(this.getOldFallDistance());
            final java.lang.Object $shipTouched = this.getShipTouched();
            result = result * PRIME + ($shipTouched == null ? 43 : $shipTouched.hashCode());
            return result;
        }
