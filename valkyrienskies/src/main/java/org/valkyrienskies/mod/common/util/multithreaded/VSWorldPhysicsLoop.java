...
public class VSWorldPhysicsLoop implements Runnable {
    ...
    private static long getNsPerTick() {
        return (long) (1000000000 / VSConfig.targetTps);
    }
    ...
    public void run() {
        while (threadRunning) {
            ...
            if (tickPhysics) {
                ...
                final long idealTickTime = (long) (1.0E9 / VSConfig.targetTps);
                ...
                if (physTickDuration < idealTickTime) {
                    final long sleepMillis = (idealTickTime - physTickDuration) / 1000000L;
                    try {
