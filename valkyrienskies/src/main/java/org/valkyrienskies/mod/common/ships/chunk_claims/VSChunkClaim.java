...
public final class VSChunkClaim implements Iterable<ChunkPos> {
    ...
    // This annotation tells Jackson to use this constructor for the class
    ...
    private ImmutableSet<Long> calculateChunkLongs() {
        return claimedChunks.stream().collect(ImmutableSet.toImmutableSet());
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof VSChunkClaim)) return false;
        final VSChunkClaim other = (VSChunkClaim) o;
        final java.lang.Object this$centerPos = this.getCenterPos();
        final java.lang.Object other$centerPos = other.getCenterPos();
        if (this$centerPos == null ? other$centerPos != null : !this$centerPos.equals(other$centerPos)) return false;
        final java.lang.Object this$claimedChunks = this.getClaimedChunks();
        final java.lang.Object other$claimedChunks = other.getClaimedChunks();
        if (this$claimedChunks == null ? other$claimedChunks != null : !this$claimedChunks.equals(other$claimedChunks)) return false;
        return true;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final java.lang.Object $centerPos = this.getCenterPos();
        result = result * PRIME + ($centerPos == null ? 43 : $centerPos.hashCode());
        final java.lang.Object $claimedChunks = this.getClaimedChunks();
        result = result * PRIME + ($claimedChunks == null ? 43 : $claimedChunks.hashCode());
        return result;
    }
}
