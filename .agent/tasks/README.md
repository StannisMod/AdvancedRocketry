...
| [TASK-46-FF](TASK-46-free-flight-v2-perception-engines-fa.md) | Free Flight v2 — camera-nose lock (mouse-as-rate), Elite-style engine start (hold Space 3 s, auto-shutdown on touchdown), velocity-setpoint Flight Assist (X = zero setpoint, N = Newtonian, H/B removed), per-axis HUD thrust/velocity bars. Every phase gated on perception-contract client e2e. (NOTE: collided with 1.12's TASK-46/CompatibilityMgr on merge — renumber pending.) | 🔵 Implemented — awaiting combined manual playtest | All 5 phases shipped 2026-06-11 (camera lock 436f63f0, engines+FA 5c156c1b, HUD b3522844). |
