...
/**
 * Repro (bug-report-workflow Step 1) for findings C002 / FIND-002 and
 * C155 / FIND-199 (HIGH) — the MANDATORY player-visible client side.
 *
 ...
 * Ledgered — see {@code .agent/history/known-bugs-ledger.md} Batch #2.</p>
 */
