...
public class VSRemoteBodyModelGateE2ETest extends AbstractClientE2ETest {
    ...
    public void aBodyStandingOnTerrainBesideARolledShipIsNotDrawnShipAligned() throws Exception {
        ...
        for (double[] spot : valid) {
            ...
            // (ledger #99). Without it a pass is silent about the fix and could be the muffler, not the cure.
            System.out.println(String.format(java.util.Locale.ROOT,
    ...
    /** Re-stage the subject at most this many times when the client does not draw it (ledger #99). At
     ...
     *  fresh spot (ledger #99: a world body inside a ship box is intermittently not drawn under load).
