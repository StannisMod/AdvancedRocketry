...
public final class FreeFlightInput {
    ...
    /** Legacy 5-channel constructor (no strafe / cut). */
    public FreeFlightInput(float throttleForward,
                           float throttleVertical,
                           float yawInput,
                           float pitchInput,
                           float brakeInput) {
        this(throttleForward, throttleVertical, 0f, yawInput, pitchInput, brakeInput, false);
    }
    ...
    public static FreeFlightInput zero() {
        return new FreeFlightInput(0f, 0f, 0f, 0f, 0f, 0f, false);
    }
    ...
    public static FreeFlightInput read(ByteBuf in) {
        ...
        return new FreeFlightInput(f, v, s, y, p, b, cut);
    }
    ...
    public String toString() {
        return String.format("FreeFlightInput{fwd=%.3f vert=%.3f strafe=%.3f yaw=%.3f pitch=%.3f brake=%.3f cut=%b}",
                throttleForward, throttleVertical, strafeInput, yawInput, pitchInput, brakeInput, cutActive);
    }
}
